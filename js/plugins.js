function TyperSetup() {
    ...
    var i;
    for (t = 0; i = elements2[t++];) {
        var n = new Cursor(i);
        n.owner.cursor = n, console.log(n.owner.cursor)
    }
}(function (t) {
                    ...
                    mousemove: function (t) {
                        ...
                        if (n) {
                            var o = Math.abs(n.x - e.x),
                                s = Math.abs(n.y - e.y);
                            if ((o > 0 || s > 0) && 4 >= o && 4 >= s && 300 >= e.timeStamp - n.timeStamp && (mouse = !0, i)) {
                                var r = $(t.target).closest("a");
                                r.is("a") && $.each(menuTrees, function () {
                                    return $.contains(this.$root[0], r[0]) ? (this.itemEnter({
                                        currentTarget: r[0]
                                    }), !1) : void 0
                                }), i = !1
                            }
        ...
        ! function () {
            ...
            e.prototype.init = function () {
                ...
                if (!r.lGalleryOn || s !== e) {
                    ...
                    if (!r.lgBusy) {
                        var u, c, h;
                        if (this.s.download) u = r.s.dynamic ? !1 !== r.s.dynamicEl[e].downloadUrl && (r.s.dynamicEl[e].downloadUrl || r.s.dynamicEl[e].src) : "false" !== r.$items.eq(e).attr("data-download-url") && (r.$items.eq(e).attr("data-download-url") || r.$items.eq(e).attr("href") || r.$items.eq(e).attr("data-src")), u ? (t("#lg-download").attr("href", u), r.$outer.removeClass("lg-hide-download")) : r.$outer.addClass("lg-hide-download");
                        if (this.$el.trigger("onBeforeSlide.lg", [s, e, i, n]), r.lgBusy = !0, clearTimeout(r.hideBartimeout), ".lg-sub-html" === this.s.appendSubHtmlTo && setTimeout(function () {
                                r.addHtml(e)
                            }, l), this.arrowDisable(e), o || (e < s ? o = "prev" : e > s && (o = "next")), i) this.$slide.removeClass("lg-prev-slide lg-current lg-next-slide"), a > 2 ? (c = e - 1, h = e + 1, 0 === e && s === a - 1 ? (h = 0, c = a - 1) : e === a - 1 && 0 === s && (h = 0, c = a - 1)) : (c = 0, h = 1), "prev" === o ? r.$slide.eq(h).addClass("lg-next-slide") : r.$slide.eq(c).addClass("lg-prev-slide"), r.$slide.eq(e).addClass("lg-current");
                        else r.$outer.addClass("lg-no-trans"), this.$slide.removeClass("lg-prev-slide lg-next-slide"), "prev" === o ? (this.$slide.eq(e).addClass("lg-prev-slide"), this.$slide.eq(s).addClass("lg-next-slide")) : (this.$slide.eq(e).addClass("lg-next-slide"), this.$slide.eq(s).addClass("lg-prev-slide")), setTimeout(function () {
